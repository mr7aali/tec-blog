       ...
       <div >
        ...
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
          ...
          <div className="flex justify-center">
            <div href="#!" className="mr-6 text-gray-600">
            ...
            <div href="#!" className="text-gray-600">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="">
              ...
              <p className="mb-4">
                <Link href="# !" className="text-gray-600">Angular</Link>
              </p>
              <p className="mb-4">
                <Link href="# !" className="text-gray-600">React</Link>
              </p>
              <p className="mb-4">
                <Link href="# !" className="text-gray-600">Vue</Link>
              </p>
              <p>
                <Link href="# !" className="text-gray-600">Laravel</Link>
              </p>
            </div>
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
              ...
              <p className="mb-4">
                <Link href="#!" className="text-gray-600">Pricing</Link>
              </p>
              <p className="mb-4">
                <Link href="#!" className="text-gray-600">Settings</Link>
              </p>
              <p className="mb-4">
                <Link href="#!" className="text-gray-600">Orders</Link>
              </p>
              <p>
